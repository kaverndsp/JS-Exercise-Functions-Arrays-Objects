...
*/
function makeSmartPerson(arg) {
  const object = {name: arg,
...
function getLastCarInfo(index) {
  const getLastCar = index[index.length - 1];
 ...
 * it will return `This is a Lincoln Navigator`.
*/
function getCarInfoById(index, id) {
  var getId = index.find(index => {
    return index.id === 1
...
function sortCarInventory(inventory) {
  ...
  return inventory.sort(function(a, b){return a.car_model - b.car_model});
}
